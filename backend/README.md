...
## Project Structure
    ...
    ├── julyapplication_dev_97645  # Django project configurations
...
1. Clone this repo and `cd julyapplication_dev_97645`
...
2. Clone this repo and `cd julyapplication_dev_97645`
